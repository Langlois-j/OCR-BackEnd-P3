# Projet3 OCR BackEND
Dépôt de l’étudiant pour le projet 3 du parcours Développeur Back-End .NET. Afin d'être au plus proche d'une situation professionnelle réelle.
...
# Importants
Les éléments suivant ne doivent pas être modifiés
- IdentitySeedData.cs 
- P3Referential.cs 
- SeedData.cs 
- les fichiers e qui se trouvent dans le dossier “Migrations” et ses sous dossiers
